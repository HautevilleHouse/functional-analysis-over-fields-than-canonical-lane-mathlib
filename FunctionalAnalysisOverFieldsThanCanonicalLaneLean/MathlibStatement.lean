import HautevilleHouse.FunctionalAnalysisOverFieldsThanCanonicalLaneLean.FinalTheorem
...
def theoremSpecificEndgamePilotClosed : Prop :=
  forall A : AdmissibleClass, ConstrainedFunctionalClosure A

theorem theorem_specific_endgame_pilot_checked :
    theoremSpecificEndgamePilotClosed := by
  intro A
  exact constrained_functional_endgame A
